...
<nav class="navbar navbar-inverse navbar-fixed-top"  >
  <div class="container-fluid">
    ...
    <li><a href="#"></a></li>
      ...
      <li class="active"><a href="{{url('/all')}}"><i class='fas fa-list' style='font-size:25px;color:white'></i>  TOUS LES TRAJETS</a></li>
      <li><a href="/voiture"><i class='fas fa-search' style='font-size:25px;color:white'></i>  CHERCHER UN TRAJET</a></li>
