...
<h3><div class="fa fa-money">  Prix:  <span style="color:red;">{{$trajet->prix}} Dt</span></div></h3>
    ...
    <h3><div class='fas fa-clock'>  Date  : <span style="color:red;"> {{$trajet->date}}&nbsp;&nbsp;{{$trajet->heure}}</span></div></h3>
      <div class="hidea">
        ...
        <input type="hidden" value="{{$trajet->id}}" name="ids">

      </div>
   </div>
<div class="text text-right">
<a href="modifier{{$trajet->id}}" class="btn btn-info" >Modifier</a>
<a href="deletess{{$trajet->id}}"><button class="btn btn-danger">Supprimer</button></a>
</div>
<br>
</div>
<br>
